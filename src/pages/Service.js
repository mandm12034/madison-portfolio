  ...
  <Layout>
    <div id="main">
      <div className="inner">
        ...
        from my managers, I have also learned to adapt quickly to 
        new situations, and I know how to work well under pressure.
        </p>
        <p>
        ...
        and International Culture, and Introduction to 
        Hospitality and Tourism Management, which were really
        cool classes just to learn more about the hospitality
        industry overall.
        </p>
        <p>
        I do love to interact with new people and different
        cultures, but I would also like to expand my knowledge
        and love of technology into the hospitality world too.
        </p>
      </div>
    </div>
  </Layout>
